  ...
  return (
    <section id="calendar" className="py-20 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-5xl font-bold mb-6 gradient-text">Calendário de Atuações 2025</h2>
        ...
        <div className="calendar-grid">
          {events.map((event, index) => (
            <motion.div
              ...
              className="event-card frosted-glass-event rounded-xl p-6"
            >
              ...
              <Button
                ...
                className="w-full mt-4 bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-semibold"
              >
                Mais Informações
              </Button>
            </motion.div>
